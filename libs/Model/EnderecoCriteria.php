...
require_once("DAO/EnderecoCriteriaDAO.php");

/**
 * The EnderecoCriteria class extends EnderecoDAOCriteria and is used
 ...
 * @version 1.0
 */
class EnderecoCriteria extends EnderecoCriteriaDAO
{
