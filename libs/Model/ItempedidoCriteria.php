...
require_once("DAO/ItempedidoCriteriaDAO.php");

/**
 * The ItempedidoCriteria class extends ItempedidoDAOCriteria and is used
 ...
 * @version 1.0
 */
class ItempedidoCriteria extends ItempedidoCriteriaDAO
{
