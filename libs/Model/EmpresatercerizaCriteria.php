...
require_once("DAO/EmpresatercerizaCriteriaDAO.php");

/**
 * The EmpresatercerizaCriteria class extends EmpresatercerizaDAOCriteria and is used
 ...
 * @version 1.0
 */
class EmpresatercerizaCriteria extends EmpresatercerizaCriteriaDAO
{
