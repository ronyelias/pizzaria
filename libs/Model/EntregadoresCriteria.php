...
require_once("DAO/EntregadoresCriteriaDAO.php");

/**
 * The EntregadoresCriteria class extends EntregadoresDAOCriteria and is used
 ...
 * @version 1.0
 */
class EntregadoresCriteria extends EntregadoresCriteriaDAO
{
