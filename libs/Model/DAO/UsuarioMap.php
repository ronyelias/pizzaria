...
class UsuarioMap implements IDaoMap, IDaoMap2
{
	...
	public static function GetFieldMaps()
	{
		if (self::$FM == null)
		{
			...
			self::$FM["Login"] = new FieldMap("Login","usuario","login",false,FM_TYPE_VARCHAR,10,null,false);
			self::$FM["Senha"] = new FieldMap("Senha","usuario","senha",false,FM_TYPE_VARCHAR,10,null,false);
		}
		return self::$FM;
	}
